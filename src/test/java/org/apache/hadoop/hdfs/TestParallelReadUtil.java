...
@Disabled
public class TestParallelReadUtil extends JindoSingleClusterTestBase {
    ...
    static {
        ...
        LogManager.getLogger(TestParallelReadUtil.class.getName() + ".clienttrace")
                .setLevel(Level.WARN);
    }
    ...
    boolean runParallelRead(int nFiles, int nWorkerEach, ReadWorkerHelper helper) throws IOException {
        ...
        for (int i = 0; i < nFiles; ++i) {
            ...
            testInfo.filepath = makeTestPath("TestParallelRead.dat." + i);
