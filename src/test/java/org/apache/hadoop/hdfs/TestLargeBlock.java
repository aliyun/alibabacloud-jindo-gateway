...
public class TestLargeBlock extends JindoMultiClusterTestBase {
    ...
    public void runTest(final long blockSize) throws IOException {
        ...
        try {
            ...
            Path file1 = new Path(makeTestPathStr("tmp/TestLargeBlock"), blockSize + ".dat");
